	...
	useEffect(() => {
		...
		const handleCardClickPos = (dif) => {
			...
			let currentOriginalPos =
				originals.findIndex(
					(original) =>
						original.querySelector(".card-title").innerHTML === check.querySelector(".card-title").innerHTML
				) + 1;
				...
				<div className="cards" style={{ transform: "translate(-920px)" }}>
					...
					<div className="card">
						...
						<p className="card-description">
							Una aplicación móvil que da acceso a cualquier persona a sus rangos de Rocket League desde su
							teléfono. Esta aplicación está pensada para todos los jugadores de Rocket League, aqui podran
							seguir su progreso, encontrar sus rangos, sus estadisticas y sus partidos jugados. La solución
							consiste en 4 páginas, un inicio de sesión, una pagina principal, una de estadisticas y una de
							partidos.
						</p>
						<div className="card-stacks">
					...
					<div className="card visible">
						...
						<p className="card-description">
							Una página web que brinda herramientas de ayuda a jóvenes y adultos en etapa laboral con déficit
							de atención. Se brindan herramientas tales como recordatorios, organizadores, una sección de
							estudio (donde puedas establecer un tiempo de trabajo y te dé tiempos de recreo en proporción al
							trabajo y que te vaya guiando para que puedas lograr un estudio efectivo), una sección de
							ejercicios de relajación y por último una sección de notas para cuando el usuario esté en la
							escuela/trabajo, pueda tomar sus apuntes y tener todo organizado.
						</p>
						<div className="card-stacks">
					...
					<div className="card">
						...
						<p className="card-description">
							Una aplicación móvil para ver tus eventos de una forma más divertida. Podrás crear 2 tipos de
							eventos, pasados o futuros. Para los eventos futuros, podrás ponerle un título y activar un
							recordatorio para el momento del evento o para un tiempo antes. Cuando ya lo tengas creado,
							podrás acceder a una pantalla donde hay una cuenta regresiva para el evento. Para los eventos
							pasados, vas a poder ver el tiempo que pasó desde la fecha indicada de una manera distinta.
							Podrás ver la cantidad exacta que pasó de cada medida de tiempo, por ejemplo, te dirá la
							cantidad de segundos que pasaron desde que naciste.
						</p>
						<div className="card-stacks">
